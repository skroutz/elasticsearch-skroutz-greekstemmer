...
public class SkroutzGreekStemmerTest {
  ...
  private static final String[] words = { "προσκλητηριο", "προσκλητηρια",
      ...
      "ματι", "ματια", "ματιων", "μαγιω", "μαγιο", "παντελονα", "λαδικο",
      "περιστροφικο", "διαφορικο", "τηλεσκοπικο", "λαβασ", "χαρτησ", "χαρτεσ",
      "χαρτων", "ντουλαπασ", "ντουλαπων"};
  ...
  private static final String[] stems = { "προσκλητηρ", "προσκλητηρ",
      ...
      "σπορο", "σπορο", "σπορο", "βερμουδ", "ματι", "ματι", "ματι", "μαγιω",
      "μαγιο", "παντελονα", "λαδικ", "περιστροφικ", "διαφορικ", "τηλεσκοπικ",
      "λαβα", "χαρτη", "χαρτη", "χαρτη", "ντουλαπα", "ντουλαπα" };

  private static final String[] protectedWords = { "απο", "δυο", "ελα", "αμα",
    "ειτε", "εγω", "δεν", "δηλαδη", "κανο",  "θερμοσ", "στυλο",
    "μακραμε", "λαβα", "γαζι", "ντουλαπα", "βιολογοσ"};
