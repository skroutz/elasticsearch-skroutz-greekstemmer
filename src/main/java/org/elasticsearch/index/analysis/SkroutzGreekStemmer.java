...
public class SkroutzGreekStemmer {
  ...
  private static final CharArraySet exc6 = new CharArraySet(Lucene.VERSION,
      Arrays.asList("αδ", "αλ", "αμαν", "αμερ", "αμμοχαλ", "ανηθ", "αντιδ",
          ...
          "δυτ", "ειδ", "ενδ", "εξωδ", "ηθ", "θετ", "καλλιν", "καλπ", "κανον",
          "καταδ", "κουζιν", "κρ", "κωδ", "λογ",  "μ", "μερ", "μοναδ", "μουλ",
          "μουσ", "μπαγιατ", "μπαν", "μπολ", "μποσ", "μυστ", "ν", "νιτ", "ξικ",
          "οπτ", "παν", "πετσ", "πικαντ", "πιτσ", "πλαστ", "πλιατσ", "ποντ",
          "ποστελν", "πρωτοδ", "σερτ", "σημαντ", "στατ", "συναδ", "συνομηλ",
          "τελ", "τεχν", "τροπ", "τσαμ", "υποδ", "φ", "φιλον", "φυλοδ", "φυσ",
          "χασ"),
          false);
