...
Examples:
    ...
    ---------------------------------------------------------------
    | αμυνοξυ (singular)   | αμυνοξ         | αμυνοξ              |
    ---------------------------------------------------------------
    | αμυνοξεα (plural)    | αμυνοξε        | αμυνοξ              |
    ---------------------------------------------------------------


In order to install the plugin, simply run: `bin/plugin -install skroutz/elasticsearch-skroutz-greekstemmmer/0.0.1`.
